...
class SQLMixin(object):
    ...
    def update(cls, id, **kwargs):
        ...
        setattr(m, 'updated_time', current_time())
    ...
    @classmethod
    def all_by_offset(cls, offset, limit, **kwargs):
        ms = cls.query.filter_by(**kwargs).limit(limit).offset(offset)
        return ms
